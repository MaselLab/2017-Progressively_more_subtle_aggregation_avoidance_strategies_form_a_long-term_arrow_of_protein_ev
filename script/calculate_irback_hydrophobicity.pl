...
thoughout the entire CALCULATE IRBACK HYDROPHOBICITY program.
...
$mysql_insertion_statement = 'UPDATE TableName SET IrbackHydrophobicityPercentage = ? WHERE PrimaryKey = ?';
